...
class SimpleApp(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.title("Suno Master Prompt Studio v0.6.1 - Research + Female Voice Isolation Gate")
    ...
    def _build(self):
        ...
        ttk.Label(header, text="  v0.6.1 Research + Female Voice Isolation Gate", font=("Segoe UI", 10)).pack(side="left", padx=8)
    ...
    def _build_existing_tab(self):
        ...
        ttk.Label(
            ...
            text=(
                ...
                "BPM/장르/보컬/stylePrompt 등 허용된 음악 필드만 새 결과에서 가져옵니다. v0.6.1은 JP-native controls, vocalDesign↔stylePrompt 발성 충돌, 여성 전용 positive prompt의 male/duet/self-response/stack 위험 토큰까지 FAIL 처리합니다."
            ),
            foreground="#444",
            wraplength=1180,
